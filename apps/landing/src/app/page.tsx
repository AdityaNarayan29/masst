          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea placeholder="Please include all relevant information..." className="min-h-[100px]" />
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  <Label htmlFor="essential" className="text-sm font-medium">Strictly Necessary</Label>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  <Label htmlFor="functional" className="text-sm font-medium">Functional</Label>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Slider value={sliderValue} onValueChange={setSliderValue} min={12} max={24} step={1} />
              </div>
            </CardContent>
          </Card>
    ...
    <main className="min-h-screen bg-background">
      ...
      <footer className="border-t py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            Built with shadcn/ui. Open source.
          </p>
        </div>
      </footer>
    </main>
